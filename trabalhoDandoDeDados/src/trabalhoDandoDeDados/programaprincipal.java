...
while(opcao!=0){
           ...
           if(validacao.length!=3){
            ...
            System.out.println("bloco (3 digitos numéricos):");
            ...
            System.out.println("posição no bloco (2 digitos numéricos):");

            valor3 = entrada2.nextLine();
            char[] validacao3 = valor3.toCharArray();
            if(validacao3.length!=2){
               System.out.println("a posição deve possuir 2 caracteres");
               break;
            }
